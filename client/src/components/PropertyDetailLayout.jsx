...
import { ChevronLeft, MapPin, BedDouble, Bath, MoveDiagonal, Wifi, Cigarette, Utensils, Home, Car } from "lucide-react";
import { Button } from "@/components/ui/button";

const Facility = ({ children }) => (
  <div className="flex items-center gap-2 text-sm text-gray-600">{children}</div>
);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-4 md:p-6">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
              <Facility>
                <BedDouble className="w-5 h-5" /> {property?.facilities?.beds} Beds
              </Facility>
              ...
              <Facility>
                <MoveDiagonal className="w-5 h-5" /> {property?.facilities?.area}
              </Facility>
              ...
              <Facility>
                ...
                {property?.facilities?.smokingArea ? "Smoking Area" : "No Smoking"}
              </Facility>
            ...
            <div className="bg-white rounded-2xl border shadow-md overflow-hidden">
              ...
              <div className="pt-5 pb-4 text-center px-3">
                ...
                <p className="text-black text-[14px]">
                  {agentPropertiesCount} Properties
                </p>
